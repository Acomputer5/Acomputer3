...
<head>
    ...
    <title>Acomputer - Straight and short, but precise and on point!</title>
    <style>
        body {
            ...
            padding: 0;
            text-align: center;
            background: linear-gradient(to bottom, #1a3b5d, #0a1e33);
            color: white;
        } 
        .navbar {           
